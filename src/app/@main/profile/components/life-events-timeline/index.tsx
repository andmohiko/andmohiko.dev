...
const lifeEvents: LifeEvent[] = [
  ...
  },
  {
    id: '20251026',
    time: '2025.10.26 (29歳)',
    title: 'チートデイで6000kcal食べる',
    description:
      '初めて本格的なチートデイを行い、1日で6000kcal摂取した。いつもよりも早起きし、お腹を空かせるために水泳と脚トレを入れながらなんとか16時間で6000kcal食べ切った。',
  },
  {
    id: '20250517',
    time: '2025.05.17 (28歳)',
  ...
  },
  {
    ...
    description: (
      <>
        ...
        という修士論文を書く。大学4年生の頃のインターン先で自然言語処理を勉強したことから始まり、大学院生の間はメンヘラテクノロジーで働くまでの、大学生活とエンジニアキャリアの集大成のようなもの。修論発表当日のタイムラインがざわつく。
      </>
    ),
  },
  {
    ...
    description: (
      <>
        ...
        リリース前から反響があり、リリース初日に500人以上のユーザーが登録する。はじめて個人開発でバズる。不具合や考慮できていないことをたくさん発見し、プロダクト開発の難しさを学ぶ。今でもスマブラ界隈の人からはスマレポを作った人として認知されており、ニッチで熱量の高いコミュニティに向けてプロダクトを届けることの楽しさを実感している。
      </>
    ),
  },
  {
