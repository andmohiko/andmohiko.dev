...
const lifeEvents: LifeEvent[] = [
  ...
  },
  {
    ...
    title: 'DMMでインターン',
    description:
      '合同会社DMM.comの2週間のサマーインターンに参加し、動画配信プラットフォームのレコメンドエンジンの改善に取り組む。ドメイン知識を活かし、ユーザーの回遊率を上げることに成功する。商品のパッケージを会議室に映しながら「レコメンドエンジンとはどうあるべきか、どんな商品が表示されるべきか」という成果発表をする。詳しくは飲みに行ったときの聞いてください。',
  },
  {
    time: '2019.04.01 (22歳)',
    title: '大学院に進学',
