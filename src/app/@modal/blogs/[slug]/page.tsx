 ...
 */
const BlogDetailPage: React.FC<BlogDetailPageProps> = async ({
  params,
  ...
  try {
    ...
    if (!slug) {
      console.error('BlogDetailPage: slugパラメータが無効です', {
        slug,
    ...
    console.error('BlogDetailPage: ブログデータの取得に失敗しました', {
      error: error instanceof Error ? error.message : error,
      function: 'BlogDetailPage',
      params: await params,
    })
